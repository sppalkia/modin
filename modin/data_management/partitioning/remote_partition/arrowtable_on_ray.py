...
class ArrowOnRayRemotePartition(BaseRemotePartition):
    ...
    def apply(self, func, **kwargs):
        ...
        return ArrowOnRayRemotePartition(oid)
    ...
    def __copy__(self):
        return ArrowOnRayRemotePartition(object_id=self.oid)
    ...
    def width_extraction_fn(cls):
        return lambda table: table.num_columns

    @classmethod
    def empty(cls):
        return cls.put(pyarrow.Table.from_pandas(pandas.DataFrame()))
